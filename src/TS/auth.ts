...
function navigate(): void {
    ...
    let navigateSection: string = "0";
    if (hash == "#register") navigateSection = "-100%";
    if (hash == "#login") navigateSection = "-200%";
    if (hash == "#subject") navigateSection = "-300%";
    ...
    let state: string = "bottom-state_1";
    if (hash != "#" && hash != "") state = "bottom-state_2";
    if (hash == "#login" || hash == "#register") sectionPoint = 1;
    if (hash == "#subject") sectionPoint = 2;
